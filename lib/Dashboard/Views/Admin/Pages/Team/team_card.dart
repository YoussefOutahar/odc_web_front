...
class TeamCard extends StatefulWidget {
  const TeamCard({super.key, required this.teamMember, required this.onModified, required this.onDeleted});
...
class _TeamCardState extends State<TeamCard> with TickerProviderStateMixin {
  ...
  Future<void> loadImageUrl() async {
    String downloadUrl = await FirebaseStorage.instance.ref(widget.teamMember.image).getDownloadURL();
    setState(() {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        String dataUrl = await FirebaseStorage.instance.ref(widget.teamMember.pdfUrl).getDownloadURL();
