class FormationData {
  static final Map<String, dynamic> formationDoctorantData = {
    "Boîte à outils recherche scientifique": <String, String>{
      ...
      "objectifsPedagogiqueData": "Maîtriser le protocole de la recherche scientifique\n"
      ...
      "coutData": "Intervenant : 6 000dh / option                12 000dh/Pack",
    ...
    "Boîte à outils Méthodologie & encadrement": <String, String>{
      "name": "outils Management de la recherche ",
      "whyData": "•Développement des techniques et procédures d’identification et analyse des informations des sujets de recherche spécifique\n"
  ...
  static final Map<String, dynamic> formationLearningTravelData = {
    "Voyage Programmation Informatique": <String, String>{
    ...
    "Voyage entreprenariat": <String, String>{
      "name": "entreprenariat",
      "whyData": "Acquérir les compétences et les connaissances pour devenir un entrepreneur réussi\n"
      ...
      "objectifsPedagogiqueData": "Au terme de cette formation, vous serez capable de :\n"
          "Comprendre les principes de base de l'entrepreneuriat et du démarrage d'entreprise\n"
          "Identifier les opportunités d'affaires et évaluer leur potentiel\n"
          "Élaborer un plan d'affaires complet\n"
          "Gérer les finances de votre entreprise, y compris la budgétisation, la comptabilité et le financement\n"
  ...
  static final Map<String, dynamic> formationSoftSkillsData = {
    "Pack Certificat PNL": <String, String>{
      "name": "PNL",
      "whyData": "Maîtriser des techniques d’amélioration et de changement,\n"
  ...
  static final Map<String, dynamic> formationSurMesuresData = {
    "Pack E-commerce": <String, String>{
      "name": "e-commerce",
      "whyData": "La formation assure aux créateurs et gestionnaires des projets e-commerce : \n"
      ...
      "objectifsPedagogiqueData": "Maîtriser les concepts clés du e-commerce;\n"
    ...
    "Pack Lean Management & Six Sigma": <String, String>{
    ...
    "Pack Optimisation des process": <String, String>{
      ...
      "whyData": "Une formation opérationnelle détaillant la méthodologie et les outils de l'approche par processus;\n"
